...
<head>
    ...
    <title>Pembayaran SPP SMK Nyx Kota Bogor</title>
    ...
    <div class="row">
        <div class="col-12">
            <nav class="main-nav">
                ...
                <!-- ***** Menu Start ***** -->
                <ul class="nav">
                    <li><h3>Pembayaran SPP Siswa SMK Nyx </h3></li>
                    <li></li>
                    <li></li>
                    <li></li>
                    <li></li>
                    
                    <li><a data-bs-toggle="modal" data-bs-target="#studentAddModal" style="font-size:medium; color:white">Tambah Pembayaran SPP<img src="assets/art/ProfMartin.png" alt=""></a></li>
                </ul>   
...
<div class="row">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Tambah Pembayaran SPP</h5>
    ...
    <div class="modal fade" id="studentEditModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Edit Pembayaran SPP</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
    ...
    <div class="modal fade" id="studentViewModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Lihat Pembayaran SPP</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    ...
                    <tbody>
                        ...
                        ?>
                                <tr>
                                    ...
                                    <td><?= $student['tgl'] ?></td>
                                    <td>
                                        <button type="button" value="<?= $student['id']; ?>" class="viewStudentBtn btn btn-info btn-sm">Lihat</button>
                                        <button type="button" value="<?= $student['id']; ?>" class="editStudentBtn btn btn-success btn-sm">Edit</button>
                                        <button type="button" value="<?= $student['id']; ?>" class="deleteStudentBtn btn btn-danger btn-sm">Hapus</button>
                                    </td>
                                </tr>
                        <?php
                            }
